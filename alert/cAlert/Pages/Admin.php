 ...
 */
namespace Cover\Pages;

use Cover\Api\SettingsApi;
use Cover\Base\BaseController;
use Cover\Api\Callbacks\AdminCallbacks;
...
class Admin extends BaseController
{
    ...
    public function setPages(){
        $this->pages = array(
            array(
                'page_title' => 'Alert Questionnaire Plugin',
                'menu_title' => 'Alert',
                'capability' => 'manage_options',
                'menu_slug' => 'alert_plugin',
