...
//        }
    ...
    public function generate_buttons()
    {
        ...
        echo '</script>';
        return "<div id='tra_button_pane'><a class='button' id='tra_back' href='#' onclick='return false;'>$this->back_string</a> <a class='button' id='tra_submit' href='$this->pdfurl' onclick='myFunction()' download>$this->submit_string</a></div>";
    }
}
