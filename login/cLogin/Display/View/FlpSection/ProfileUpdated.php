...
class ProfileUpdated {
    ...
    public function update($data, $email) {
        ...
        // If flp_experience_with_radicalisation more than one implode in one array and if other skills exists concatenate in the same array
...
//        unset($data['other_skills']);
        ...
        // If flp_working_with more than one implode in one array and if other skills exists concatenate in the same array
