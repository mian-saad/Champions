...
class ExpertLogin extends TraState {
    ...
    {
        return "<div id='register_button_pane'><a class='button'  id='arena_back' href='#' onclick='window.location.reload();'>$this->back_string</a> <a class='button' id='arena_continue' href='#' onclick='return false;'>$this->login_string</a></div>";
    }
