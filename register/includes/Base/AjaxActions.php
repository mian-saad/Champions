...
class AjaxActions
{
    ...
    {
        add_action('wp_ajax_nopriv_fetc_question', array($this, 'fetc_question'));
        add_action('wp_ajax_fetc_question', array($this, 'fetc_question'));
