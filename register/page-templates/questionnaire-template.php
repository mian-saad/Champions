...
echo "<div id='registration_questionnaire_content_div'>";
...
echo "<h1> Welcome to ARENA Registration Module</h1>";
...
//echo "</select>";
//echo "</form>";
echo "<div id='tra_button_pane'><a class='button' id='arena_new_expert' href='#' onclick='return false;'>Register</a></div>";
echo "</div >";
echo "</div >";
