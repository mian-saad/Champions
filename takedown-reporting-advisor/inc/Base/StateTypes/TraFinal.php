...
class TraFinal extends TraState
{
    ...
    public function __construct($report_id, $state_code, array $answers, array $contact_proposals, $submit_string, $back_string, $crime_location_string, $language_pref_string, $residence_string, $no_results_string, $pdfurl)
    {
        $this->pdfurl = $pdfurl;
    ...
    {
        return "<div id='tra_button_pane'><a class='button' id='tra_back' href='#' onclick='return false;'>$this->back_string</a> <a class='button' id='tra_submit' href='$this->pdfurl' download>$this->submit_string</a></div>";
    }
}
