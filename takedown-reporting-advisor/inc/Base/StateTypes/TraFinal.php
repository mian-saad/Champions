...
//        $html .= $this->proposal_html;
    ...
    {
        return "<div id='tra_button_pane'><a class='button' href='#' onclick='return false;'>DONE</a> <a class='button' id='tra_submit' href='$this->pdfurl' download>$this->submit_string</a></div>";
    }
}
