...
echo "<h1> Welcome to the Takedown Reporting Advisor.</h1>";
...
echo "</select>";
echo "</form>";
echo "<div id='tra_button_pane'><a class='button' id='tra_new_report' href='#' onclick='return false;'>New report</a></div>";
echo "</div >";
echo "</div >";
